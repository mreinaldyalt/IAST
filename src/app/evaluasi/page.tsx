...
export default function EvaluasiPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8">
      ...
      <p className="text-slate-400 mb-4">{t.evalDesc}</p>
      <div className="mb-4 px-4 py-2 bg-indigo-900/20 border border-indigo-500/20 rounded-lg text-xs text-indigo-300">
        Ground truth tersedia untuk tahun 2025&ndash;2029. Tahun di luar range ini akan ditandai NO_GROUND_TRUTH.
      </div>
      ...
      {result && (
        <div className="mt-6">
          <div className="grid grid-cols-5 gap-3 mb-4">
            ...
            <div className="bg-yellow-900/20 border border-yellow-500/10 p-3 rounded-lg text-center">
              <div className="text-xs text-slate-500">No GT</div>
              <div className="text-2xl font-bold text-yellow-400">{result.totalNoGroundTruth ?? 0}</div>
            </div>
